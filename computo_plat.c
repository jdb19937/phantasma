...
int pfr_in_gpu_mitte_d(pfr_matrix_d_t *a)    {
    (void)a;
    return 0;
}
int pfr_ex_gpu_cape_d(pfr_matrix_d_t *a)     {
    (void)a;
    return 0;
}
int pfr_in_gpu_mitte_vd(pfr_vector_d_t *v)   {
    (void)v;
    return 0;
}
int pfr_ex_gpu_cape_vd(pfr_vector_d_t *v)    {
    (void)v;
    return 0;
}
